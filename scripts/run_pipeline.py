...
Full WCTE data production pipeline for a single run.
  ...
  Step 3 : Merge                                  [placeholder — C++ merger not yet available]
...
ALL_STEPS = {"wf", "calibrate", "dq", "beam"}
...
if __name__ == "__main__":
    ...
    if args.steps is None:
        ...
        pipeline_requested          = requested - {"beam"}
